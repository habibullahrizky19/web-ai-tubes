# Deployment Model CNN (Belimbing vs Jeruk)

## Deskripsi singkat

Repository ini berisi semua file yang dibutuhkan untuk melakukan deployment model Machine Learning Image Classification menggunakan CNN (Convolutional Neural Network). Adapun model yang digunakan merupakan model untuk memprediksi gambar daun Belimbing vs Jeruk.

#

## Sekilas mengenai input model

Agar dapat memprediksi daun belimbing atau jeruk, data input model harus mengikuti format sebagai berikut:
